...
4. Crea el script `hola.sh` que mostramos en el ejemplo práctico. Dale permisos de ejecución y ejecútalo.
5. Modifica `hola.sh` con Nano para agregar una línea que diga `echo "Directorio home: $HOME"`. Guarda y ejecuta de nuevo.
